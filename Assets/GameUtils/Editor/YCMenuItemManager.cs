...
namespace YsoCorp {
    namespace GameUtils {
        ...
        public class YCMenuItemManager {
            static string AMAZON_FILE = "Amazon_APS_1_8_0";
            static string FIREBASE_FILE = "FirebaseAnalytics_11_4_0";
            static string PROD_NETWORKS_FILE = "ProdNetworks_1_0_0";

            static string WEBSITE_URL = "https://gameutils.ysocorp.com/";
            static string AMAZON_URL = "https://gameutils-unity.ysocorp.com/public/unity/" + AMAZON_FILE + ".unitypackage";
            static string FIREBASE_URL = "https://gameutils-unity.ysocorp.com/public/unity/" + FIREBASE_FILE + ".unitypackage";
            static string PROD_NETWORKS_URL = "https://gameutils-unity.ysocorp.com/public/unity/" + PROD_NETWORKS_FILE + ".unitypackage";
            ...
            static void ImportAmazon() {
                YCPackageManager.DownloadAndImportPackage(AMAZON_URL, AMAZON_FILE, false);
            }

            [MenuItem("GameUtils/Import Package/Firebase", false, 1003)]
            static void ImportFirebase() {
                YCPackageManager.DownloadAndImportPackage(FIREBASE_URL, FIREBASE_FILE, false);
            }

            [MenuItem("GameUtils/Import Package/Prod Networks", false, 1004)]
            static void ImportProdNetworks() {
                YCPackageManager.DownloadAndImportPackage(PROD_NETWORKS_URL, PROD_NETWORKS_FILE, false);
            }
