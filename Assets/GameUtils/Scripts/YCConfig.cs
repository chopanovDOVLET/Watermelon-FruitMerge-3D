...
namespace YsoCorp {
    namespace GameUtils {
        ...
        public class YCConfig : ScriptableObject {
            ...
            [HideInInspector] [Obsolete("Please use YCConfig.CustomInapps instead")] public string[] InAppConsumables;
            ...
            [HideInInspector] [Obsolete("Please use CustomInapps instead")] public string[] InAppConsumables { get; set; } = { };
            ...
            [YcBoolHide("UseBanners", true)] [FormerlySerializedAs("BannerDisplayOnInitEditor")] public bool UseBannersInEditor = true;
#if UNITY_2020_1_OR_NEWER
            [YcBoolHide("UseBanners", true)] [field: SerializeField] public bool TransparentBannerBackground { get; private set; }
#else
            [YcBoolHide("UseBanners", true)] public bool TransparentBannerBackground;
#endif
